...
// time variables for Madgwick count
...
void UpdateDataMPU9250(){
    ...
    MadgwickAHRSupdateIMU(dt, gyroXscl, gyroYscl, gyroZscl, acclXscl, acclYscl, acclZscl);
//        MadgwickAHRSupdate(dt, gyroXscl, gyroYscl, gyroZscl, acclXscl, acclYscl, acclZscl, magYscl, magXscl , -magZscl);
