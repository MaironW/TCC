...
extern volatile char data[26][12];                                // string block with GGA/VTG data
extern volatile char time[8];                            // GPS time data
...
extern volatile double lat0, lon0;                       // [deg] last GPS position coordinates
extern volatile double alt0;                             // [m]   last GPS altitude data
