...
//    portDialog = new PortSelecitionWindow(this);
...
//    sensor = new Sensor(portDialog->USB);
...
void MainWindow::uiUpdate(){
    if(ui->tab_linear->isVisible()){
        ui->label_nvalue->setText(QString::number(linearplot->sensor_data->x())+" "+sensor->unit.at(ui->comboBox_sensor->currentIndex()));
        ui->label_evalue->setText(QString::number(linearplot->sensor_data->y())+" "+sensor->unit.at(ui->comboBox_sensor->currentIndex()));
        ui->label_dvalue->setText(QString::number(linearplot->sensor_data->z())+" "+sensor->unit.at(ui->comboBox_sensor->currentIndex()));
...
//        ui->label_headingvalue->setText(QString::number(sensor->euler.z())+" °");
...
//        ui->label_bankvalue->setText(QString::number(sensor->euler.x())+" °");
//        ui->label_pitchvalue->setText(QString::number(sensor->euler.y())+" °");
    }
}
