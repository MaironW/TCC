...
QT_MOC_LITERAL(3, 20, 14) // "readDataSerial"

    },
    "Sensor\0dataUpdated\0\0readDataSerial"
};
...
void Sensor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->readDataSerial(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Sensor::dataUpdated)) {
                *result = 0;
                return;
            }
        }
